  ...
  <AdminLayout>
    <div class="max-w-7xl mx-auto py-10 px-4">
      <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold text-blue-custom-800">Gestão de Agendas</h1>
        <Link
        ...
        <table class="w-full text-sm table-auto">
          ...
          <tbody>
            <tr v-for="item in schedules.data" :key="item.id" class="border-t">
              ...
              <td class="px-4 py-2">{{ item.availabilities_count }}</td>
            ...
            <tr v-if="schedules?.data?.length === 0">
              <td colspan="5" class="px-4 py-2 text-center">Nenhuma agenda encontrada.</td>
            </tr>
          </tbody>
        </table>
        <div class="mt-4">
